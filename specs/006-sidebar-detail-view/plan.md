...
| IV. Ghostel-Only Terminal Support | PASS with mitigation | The view uses registered Session titles from Ghostel. A Session may not yet have a title. The toggle reports how many Sessions have a title and explicitly identifies a sidebar with no titles. |
