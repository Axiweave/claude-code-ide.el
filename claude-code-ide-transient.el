...
(transient-define-prefix claude-code-ide-manager-dispatch ()
  ...
  [["Switch"
   ...
   ["Sessions"
    ...
    ("c" "Reattach remote session" claude-code-ide-manager-reattach-at-point)
   ...
   ["Arrange"
    ...
    ("M-n" "Move row down (lone group)" claude-code-ide-manager-move-down)
    ("M-P" "Move group up" claude-code-ide-manager-move-group-up)
