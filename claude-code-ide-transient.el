...
With prefix ARG, add the agent-specific permissions bypass flag."
  (interactive "P")
  (if (claude-code-ide--has-current-directory-session-p)
      (let ((working-dir (claude-code-ide--get-current-directory)))
        (claude-code-ide-log "Claude Code session already running in %s"
                             (abbreviate-file-name working-dir)))
    (let ((claude-code-ide-cli-extra-flags
           (if arg
...
(transient-define-prefix claude-code-ide-menu ()
  ...
  ["Claude Code IDE" :description claude-code-ide--session-status
   ...
   ["Manager"
    ...
    ("2" "Manager slot 2" (lambda () (interactive) (claude-code-ide-manager-switch-by-slot 2)) :level 8)
    ("3" "Manager slot 3" (lambda () (interactive) (claude-code-ide-manager-switch-by-slot 3)) :level 8)
    ("4" "Manager slot 4" (lambda () (interactive) (claude-code-ide-manager-switch-by-slot 4)) :level 8)
    ("5" "Manager slot 5" (lambda () (interactive) (claude-code-ide-manager-switch-by-slot 5)) :level 8)
    ("6" "Manager slot 6" (lambda () (interactive) (claude-code-ide-manager-switch-by-slot 6)) :level 8)
    ("7" "Manager slot 7" (lambda () (interactive) (claude-code-ide-manager-switch-by-slot 7)) :level 8)
    ("8" "Manager slot 8" (lambda () (interactive) (claude-code-ide-manager-switch-by-slot 8)) :level 8)
    ("9" "Manager slot 9" (lambda () (interactive) (claude-code-ide-manager-switch-by-slot 9)) :level 8)
    ("0" "Manager slot 10" (lambda () (interactive) (claude-code-ide-manager-switch-by-slot 10)) :level 8)
