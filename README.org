...
| =M-x claude-code-ide-manager-show=        | Show the CC Manager sidebar                       |
| =M-x claude-code-ide-manager-focus=       | Focus the CC Manager sidebar                      |
| =M-x claude-code-ide-manager-hide=        | Hide the CC Manager sidebar                       |
...
=claude-code-ide-manager-show= opens a dedicated left sidebar for live Claude sessions, similar to a Treemacs-style frame panel. The manager is additive: existing commands such as =claude-code-ide-list-sessions= still work as before.

The manager can:

- Show all live sessions with project name and path
