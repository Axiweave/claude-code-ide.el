...
Remote layouts show the terminal without opening a local project.
Remote project launch, interactive Git, Magit, Dired, and Treemacs actions remain unsupported.
Remote file editing, text-transfer integration, MCP, and SSE setup remain outside this mode.
