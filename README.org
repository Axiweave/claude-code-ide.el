...
#+html: <p><b>Note:</b> <a href="https://yfu.tw/blog/en/open-model-harness/">https://yfu.tw/blog/en/open-model-harness/</a> — I now use =omp= (Oh My Pi), and it is the only CLI actively checked against.</p>
...
- Image-aware =s-v= / =H-v= paste for Claude Code and Codex across =vterm=, =eat=, and =ghostel=
...
| =s-v= / =H-v= | =claude-code-ide-session-paste-clipboard= | Paste text normally, or forward clipboard images to Claude Code and Codex |
